	...
	$.fn.prettyPopin = function(settings) {
		...
		return this.each(function(){
			...
			var buildpopin = function() {
				$('body').append('<div class="prettyPopin"><a href="#" id="b_close" rel="close">Close</a><div class="introduce"></div><div class="prettyContent"><img src="'+settings.loader_path+'" alt="Loading" class="loader" /><div class="prettyContent-container"></div></div></div>');
            ...
            $c.parent().parent().find('.introduce').show();
				$c.fadeIn(function(){
